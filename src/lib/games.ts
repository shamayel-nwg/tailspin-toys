 ...
 * @param db Injectable database connection.
 ...
 * @param db Injectable database connection.
 * @param options Optional category IDs and publisher ID to filter by.
...
/** Returns one game by ID, or null when it does not exist.
 * @param db Injectable database connection.
